...
class Player(GameSprite):
  #a method that implements sprite control by keyboard arrow buttons
    ...
    def fire(self):
        ...
        bullets.add(bullet) # tambahin peluru ke sprite group
...
class Bullet(GameSprite):
    ...
    def update(self):
        ...
        if self.rect.x > win_width+10:
            self.kill() # pelurunya bakalan hilang
...
while run:
    ...
    if not finish:
        ...
        bullets.update()
        # kondisi tabrakan
        sprite.groupcollide(monsters, bullets, True, True) # kalau nabrak musuh
        sprite.groupcollide(bullets, barriers, True, False) # kalau nabrak dinding
